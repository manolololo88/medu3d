...
@media(max-width:900px){
  ...
  footer{padding:28px 20px}
      ...
      {page !== "viewer" && <div className={`mm ${menuOpen ? "open" : ""}`}>
      ...
      {/* PAGES */}
      <div className={`page-wrap ${pageVisible ? "visible" : "hidden"}`} style={page === "viewer" ? {paddingTop:0} : {}}>
      {page === "home" && <>
        <div className="hero">
      ...
      {/* Floating WhatsApp */}
      <a className={`wa-float ${cartOpen || page === "viewer" ? "hidden" : ""}`} href="https://wa.me/50662924815" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
